...
class ShareViewController: UIViewController {
    ...
    var groupContainerUrl: URL? {
        return FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: "group.com.ideamesh.ideamesh")
    }
    ...
    private func sendData() {
        ...
        var urlComps = URLComponents(string: "ideamesh://shared?")!
