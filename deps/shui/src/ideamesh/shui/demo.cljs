(ns ideamesh.shui.demo
  (:require [rum.core :as rum]
            [ideamesh.shui.ui :as ui]
            [ideamesh.shui.form.core :refer [yup yup-resolver] :as form-core]
            [promesa.core :as p]
            [ideamesh.shui.dialog.core :as dialog-core]
...
(rum/defc page []
  [:div.sm:p-10
   [:h1.text-3xl.font-bold "Ideamesh UI"]
   [:hr]
     ...
     [:div.flex.flex-row.flex-wrap.gap-2
      ...
      (ui/button
        ...
        [:a.flex.items-center.text-blue-rx-10.hover:text-blue-rx-10-alpha
         {:href "https://x.com/ideamesh" :target "_blank"}
     ...
     [:<>
      (ui/alert
        ...
        (ui/alert-description
          "content: radix colors for Ideamesh"))
      (ui/alert
