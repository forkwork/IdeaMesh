(ns ideamesh.graph-parser.text-test
...
(deftest test-get-page-name
  (are [x y] (= (text/get-page-name x) y)
         ...
         "[ideamesh/page](file:./ideamesh.page.md)" "ideamesh/page"
         "[ideamesh/page](file:./pages/ideamesh.page.md)" "ideamesh/page"))
...
#_(cljs.test/test-ns 'ideamesh.graph-parser.text-test)
