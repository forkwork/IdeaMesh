(ns ideamesh.graph-parser
  "Main ns used by ideamesh app to parse graph from source files and then save to
  the given database connection"
  (:require [datascript.core :as d]
            [ideamesh.graph-parser.extract :as extract]
...
(defn parse-file
  "Parse file and save parsed data to the given db. Main parse fn used by ideamesh app.
Options available:
