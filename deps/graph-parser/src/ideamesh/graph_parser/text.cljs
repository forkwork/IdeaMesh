...
(defn get-page-name
  ...
  ideamesh page-refs. Only call in contexts where format-specific page-refs are
  used. For ideamesh page-refs use page-ref/get-page-name"
  [s]
  (and (string? s)
