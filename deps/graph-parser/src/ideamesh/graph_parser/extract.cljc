(ns ideamesh.graph-parser.extract
  ...
  (:require [clojure.set :as set]
            ...
            #?(:org.babashka/nbb [ideamesh.graph-parser.log :as log]
...
(defn extract-whiteboard-edn
  "Extracts whiteboard page from given edn file
   ...
   - it will only contain a single page (for now). The page properties are stored under :ideamesh.tldraw.* properties and contain 'bindings' etc
