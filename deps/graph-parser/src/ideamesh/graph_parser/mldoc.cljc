(ns ideamesh.graph-parser.mldoc
  "Wraps https://github.com/khulnasoft/mldoc to parse files into mldoc ast. This ns
  ...
  (:require #?(:org.babashka/nbb ["mldoc$default" :refer [Mldoc]]
            ...
            [ideamesh.graph-parser.schema.mldoc :as mldoc-schema]))
...
(defn remove-indentation-spaces
  ...
  (let [lines (string/split-lines s)
        ...
        body (map (fn [line]
                    ...
                    ;; For markdown in Ideamesh, the indentation area for the non-first line of multi-line block is (ast level - 1) * "\t" + 2 * "(space)"
