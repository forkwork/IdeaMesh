(ns ideamesh.graph-parser.property
  "Core vars and util fns for properties"
  (:require [ideamesh.graph-parser.util :as gp-util]
...
;; Built-in properties are properties that ideamesh uses for its features. Most of
...
(def editable-linkable-built-in-properties
  "Properties used by ideamesh that user can edit and that can have linkable property values"
  #{:alias :aliases :tags})
...
(def editable-view-and-table-properties
  ...
  #{;; view props
    :ideamesh.color
    ;; table props
    :ideamesh.table.version :ideamesh.table.compact :ideamesh.table.headers :ideamesh.table.hover
    :ideamesh.table.borders :ideamesh.table.stripes :ideamesh.table.max-width})

(defn editable-built-in-properties
  "Properties used by ideamesh that user can edit"
  []
  (set/union #{:title :icon :template :template-including-parent :public :filters :exclude-from-graph-view
               :ideamesh.query/nlp-date
          ;; org-mode only
               :macro :filetags}
...
(defn hidden-built-in-properties
  "Properties used by ideamesh that user can't edit or see"
  []
  (set/union
   #{:id :custom-id :background-color :background_color :heading :collapsed
     ...
     :hl-type :hl-page :hl-stamp :hl-color :ideamesh.macro-name :ideamesh.macro-arguments
     :ideamesh.order-list-type :ideamesh.tldraw.page :ideamesh.tldraw.shape
     ; task markers
...
(def built-in-property-types
  ...
  {:template-including-parent :boolean
   ...
   :ideamesh.query/nlp-date :boolean
   :heading :boolean
   :collapsed :boolean
   :created-at :integer
   :created_at :integer
