(ns ^:node-only ideamesh.publishing.export
...
(defn create-export
  ...
  [html static-dir repo-path output-dir {:keys [notification-fn]
                                         ...
                                         :as options}]
  (let [custom-css-path (node-path/join repo-path "ideamesh" "custom.css")
        export-css-path (node-path/join repo-path "ideamesh" "export.css")
        custom-js-path (node-path/join repo-path "ideamesh" "custom.js")
        output-static-dir (node-path/join output-dir "static")
