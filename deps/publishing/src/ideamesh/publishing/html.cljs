    ...
    (str "<!DOCTYPE html>\n"
         (html
          (list
           ...
           [:body
            [:div {:id "root"}]
            [:script (gstring/format "window.ideamesh_db=%s" (js/JSON.stringify (escape-html transit-db)))]
            [:script (str "window.ideamesh_state=" (js/JSON.stringify (pr-str app-state)))]
