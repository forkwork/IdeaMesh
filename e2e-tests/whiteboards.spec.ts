...
test('create new whiteboard', async ({ page }) => {
  ...
  await expect(page.locator('.ideamesh-tldraw')).toBeVisible()
})
...
test('draw a rectangle', async ({ page }) => {
  const canvas = await page.waitForSelector('.ideamesh-tldraw')
  ...
  await expect(page.locator('.ideamesh-tldraw .tl-box-container')).toHaveCount(1)
})

test('undo the rectangle action', async ({ page }) => {
  await page.keyboard.press(modKey + '+z')

  await expect(page.locator('.ideamesh-tldraw .tl-positioned-svg rect')).toHaveCount(0)
})
...
test('clone the rectangle', async ({ page }) => {
  ...
  await expect(page.locator('.ideamesh-tldraw .tl-box-container')).toHaveCount(2)
})
...
test('group the rectangles', async ({ page }) => {
  ...
  await expect(page.locator('.ideamesh-tldraw .tl-group-container')).toHaveCount(1)
})
...
test('delete the group', async ({ page }) => {
  ...
  await expect(page.locator('.ideamesh-tldraw .tl-group-container')).toHaveCount(0)
    // should also delete the grouped shapes
  await expect(page.locator('.ideamesh-tldraw .tl-box-container')).toHaveCount(0)
})
...
test('connect rectangles with an arrow', async ({ page }) => {
  ...
  await expect(page.locator('.ideamesh-tldraw .tl-line-container')).toHaveCount(1)
})

test('delete the first rectangle', async ({ page }) => {
  await page.keyboard.press('Escape')
  await page.waitForTimeout(1000)
  await page.click('.ideamesh-tldraw .tl-box-container:first-of-type')
  await page.keyboard.press('Delete')

  await expect(page.locator('.ideamesh-tldraw .tl-box-container')).toHaveCount(1)
  await expect(page.locator('.ideamesh-tldraw .tl-line-container')).toHaveCount(0)
})
...
test('convert the first rectangle to ellipse', async ({ page }) => {
  ...
  await expect(page.locator('.ideamesh-tldraw .tl-ellipse-container')).toHaveCount(1)
  await expect(page.locator('.ideamesh-tldraw .tl-box-container')).toHaveCount(1)
})
...
test('change the color of the ellipse', async ({ page }) => {
  ...
  await expect(page.locator('.ideamesh-tldraw .tl-ellipse-container ellipse:last-of-type')).toHaveAttribute('fill', 'var(--ls-wb-background-color-red)')
})

test('undo the color switch', async ({ page }) => {
  await page.keyboard.press(modKey + '+z')

  await expect(page.locator('.ideamesh-tldraw .tl-ellipse-container ellipse:last-of-type')).toHaveAttribute('fill', 'var(--ls-wb-background-color-default)')
})
...
test('undo the shape conversion', async ({ page }) => {
  ...
  await expect(page.locator('.ideamesh-tldraw .tl-box-container')).toHaveCount(2)
  await expect(page.locator('.ideamesh-tldraw .tl-ellipse-container')).toHaveCount(0)
})
...
test('move arrow to back', async ({ page }) => {
  await page.keyboard.press('Escape')
  await page.waitForTimeout(1000)
  await page.click('.ideamesh-tldraw .tl-line-container')
  await page.keyboard.press('Shift+[')

  await expect(page.locator('.ideamesh-tldraw .tl-canvas .tl-layer > div:first-of-type > div:first-of-type')).toHaveClass('tl-line-container')
})
...
test('move arrow to front', async ({ page }) => {
  ...
  await expect(page.locator('.ideamesh-tldraw .tl-canvas .tl-layer > div:first-of-type > div:first-of-type')).not.toHaveClass('tl-line-container')
})
...
test('create a block', async ({ page }) => {
  ...
  await expect(page.locator('.ideamesh-tldraw .tl-ideamesh-portal-container')).toHaveCount(1)
})
...
test.skip('expand the block', async ({ page }) => {
  ...
  await expect(page.locator('.ideamesh-tldraw .tl-ideamesh-portal-container .tl-ideamesh-portal-header')).toHaveCount(1)
})
...
test.skip('undo the expand action', async ({ page }) => {
  ...
  await expect(page.locator('.ideamesh-tldraw .tl-ideamesh-portal-container .tl-ideamesh-portal-header')).toHaveCount(0)
})

test('undo the block action', async ({ page }) => {
  await page.keyboard.press(modKey + '+z')

  await expect(page.locator('.ideamesh-tldraw .tl-ideamesh-portal-container')).toHaveCount(0)
})
...
test('copy/paste url to create an iFrame shape', async ({ page }) => {
  ...
  await page.keyboard.type('https://ideamesh.khulnasoft.com')
  await page.keyboard.press(modKey + '+a')
  ...
  await expect( page.locator('.ideamesh-tldraw .tl-iframe-container')).toHaveCount(1)
})
...
test('copy/paste X status url to create a Post shape', async ({ page }) => {
  ...
  await page.keyboard.type('https://x.com/ideamesh/status/1605224589046386689')
  await page.keyboard.press(modKey + '+a')
  await page.keyboard.press(modKey + '+c')
  await page.keyboard.press('Escape')
  ...
  await expect( page.locator('.ideamesh-tldraw .tl-tweet-container')).toHaveCount(1)
})
...
test('copy/paste twitter status url to create a Tweet shape', async ({ page }) => {
  ...
  await page.keyboard.type('https://twitter.com/ideamesh/status/1605224589046386689')
  await page.keyboard.press(modKey + '+a')
  await page.keyboard.press(modKey + '+c')
  await page.keyboard.press('Escape')
  ...
  await expect( page.locator('.ideamesh-tldraw .tl-tweet-container')).toHaveCount(2)
})
...
test('copy/paste youtube video url to create a Youtube shape', async ({ page }) => {
  ...
  await expect(page.locator('.ideamesh-tldraw .tl-youtube-container')).toHaveCount(1)
})
...
test('open context menu', async ({ page }) => {
  await page.locator('.ideamesh-tldraw').click({ button: 'right' })
...
test('quick add another whiteboard', async ({ page }) => {
  ...
  await expect(
    page.locator('.tl-ideamesh-portal-container >> text=my-whiteboard-2')
  ).toBeVisible()
})

test('go to another board and check reference', async ({ page }) => {
  await page
    .locator('.tl-ideamesh-portal-container >> text=my-whiteboard-2')
    .click()
  await expect(page.locator('.whiteboard-page-title .title')).toContainText(
    'my-whiteboard-2'
  )
...
test('Create an embedded whiteboard', async ({ page }) => {
  ...
  await expect(quickAdd$).toBeHidden()
  await expect(page.locator('.tl-ideamesh-portal-header a')).toContainText('My embedded whiteboard')
})

test('New whiteboard should have the correct name', async ({ page }) => {
  page.locator('.tl-ideamesh-portal-header a').click()
...
test('Create an embedded page', async ({ page }) => {
  ...
  await expect(quickAdd$).toBeHidden()
  await expect(page.locator('.tl-ideamesh-portal-header a')).toContainText('My page')
})
