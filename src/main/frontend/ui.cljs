(ns frontend.ui
  ...
  (:require ["@ideamesh/react-tweet-embed" :as react-tweet-embed]
  ...
  [:section.border.mt-1.p-1.cursor-pointer.block-content-fallback-ui
   ...
   [:div.flex.justify-between.items-center.px-1
    ...
    [:a.text-xs.opacity-50.hover:opacity-80
     {:href "https://github.com/khulnasoft/ideamesh/issues/new?labels=from:in-app&template=bug_report.yaml"
     ...
     (rum/use-effect!
      (fn []
        (let [div (js/document.createElement "div")
          ...
          (.setAttribute div "data-ideamesh-portal" (str (d/squuid)))
