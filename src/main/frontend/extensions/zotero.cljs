...
(rum/defc data-directory-setting []
  [:div.row
   [:label.title
    ...
    [:a.ml-2
     {:title  "Set Zotero data directory to open pdf attachment in Ideamesh. Click to learn more."
...
(rum/defcs add-all-items <
  ...
  [:div
   ...
   (ui/admonition
     :warning
     "If you have a lot of items in Zotero, adding them all can slow down Ideamesh. You can type /zotero to import specific item on demand instead.")
...
(rum/defc zotero-imported-file
  ...
  (if (str/blank? (setting/setting :zotero-data-directory))
    [:p.warning "This is a zotero imported file, setting Zotero data directory would allow you to open the file in Ideamesh"]
...
(rum/defc zotero-linked-file
  ...
  (if (str/blank? (setting/setting :zotero-linked-attachment-base-directory))
    [:p.warning "This is a zotero linked file, setting Zotero linked attachment base directory would allow you to open the file in Ideamesh"]
