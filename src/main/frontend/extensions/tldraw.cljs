(ns frontend.extensions.tldraw
  ...
  (:require ["/frontend/tldraw-ideamesh" :as TldrawIdeamesh]
...
(def tldraw (r/adapt-class (gobj/get TldrawIdeamesh "App")))

(def generate-preview (gobj/get TldrawIdeamesh "generateJSXFromModel"))
