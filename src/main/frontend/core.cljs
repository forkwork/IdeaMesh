...
(defn display-welcome-message
  ...
  (js/console.log
   "
    Welcome to Ideamesh!
    If you encounter any problem, feel free to file an issue on GitHub (https://github.com/khulnasoft/ideamesh)
    or join our forum (https://discuss.ideamesh.khulnasoft.com).
    .____
