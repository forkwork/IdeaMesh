...
(defn invoke-exported-api
  [type & args]
  (try
    (apply js-invoke (aget js/window.ideamesh "api") type args)
...
;; state handlers
(defonce central-endpoint "https://raw.githubusercontent.com/ideamesh/marketplace/master/")
