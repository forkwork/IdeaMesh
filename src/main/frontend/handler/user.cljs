...
(defn upgrade []
  (let [base-upgrade-url "https://ideameshdemo.lemonsqueezy.com/checkout/buy/13e194b5-c927-41a8-af58-ed1a36d6000d"
        user-uuid (user-uuid)
    ...
    (js/window.open url)))
  ; (js/window.open
  ;   "https://ideameshdemo.lemonsqueezy.com/checkout/buy/13e194b5-c927-41a8-af58-ed1a36d6000d"))
