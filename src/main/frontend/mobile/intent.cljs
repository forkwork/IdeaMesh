...
(defn- embed-text-file
  "Store external content with url into Ideamesh repo"
  [url title]
          ...
          content (cond
                    ...
                    (notification/show!
                     [:div
                      ...
                      [:a {:href "https://github.com/khulnasoft/ideamesh/issues"
    ...
    (cond
      ...
      (notification/show!
       [:div
        ...
        [:a {:href "https://github.com/khulnasoft/ideamesh/issues/new?labels=from:in-app&template=bug_report.yaml"
             :target "_blank"} "Github"]
        ". We will look into it soon."
