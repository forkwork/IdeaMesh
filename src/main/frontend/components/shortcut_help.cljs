  ...
  (let [list [:bold :italics :del :mark :latex :code :link :pre :img]
        ...
        raw (case preferred-format
              :markdown {:bold (str "**" (t :bold) "**")
                         ...
                         :code (str "`" (t :code) "`")
                         :pre "```clojure\n  (println \"Hello world!\")\n```"
                         :img "![image](https://asset.ideamesh.khulnasoft.com/static/img/logo.png)"}
              :org {:bold (str "*" (t :bold) "*")
                    ...
                    :latex "$$E = mc^2$$"
                    :code "~Code~"
                    :img "[[https://asset.ideamesh.khulnasoft.com/static/img/logo.png][image]]"})
        ...
        rendered {:italics [:i (t :italics)]
                  ...
                  :img [:img {:style {:float "right" :width 32 :height 32}
                              :src "https://asset.ideamesh.khulnasoft.com/static/img/logo.png"
                              :alt "image"}]}]
