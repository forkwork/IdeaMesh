      ...
      [:div.mt-1.sm:mt-0.sm:col-span-2.flex.gap-4.items-center.flex-wrap
       [:div (cond
               ...
               (ui/button
                ...
                :class "text-sm mr-1"
                :href "https://github.com/khulnasoft/ideamesh/releases")

               (mobile-util/native-ios?)
               (ui/button
                (t :settings-page/check-for-updates)
                :class "text-sm mr-1"
                :href "https://apps.apple.com/app/ideamesh/id1601013908")
        ...
        {:title (str (t :settings-page/revision) config/revision)
         :on-click (fn []
                     (notification/show! [:div "Current Revision: "
                                          [:a {:target "_blank"
                                               :href (str "https://github.com/khulnasoft/ideamesh/commit/" config/revision)}
                                           config/revision]]
                                         :info
                                         false))}
        version]
       ...
       [:a.text-sm.fade-link.underline.inline
        {:target "_blank"
         :href "https://docs.ideamesh.khulnasoft.com/#/page/changelog"}
        ...
        (case type
          ...
          [:p (t :settings-page/update-error-1) [:br] (t :settings-page/update-error-2)
           [:a.link
            {:on-click
             (fn [e]
               (js/window.apis.openExternal "https://github.com/khulnasoft/ideamesh/releases")
               (util/stop e))}
  ...
  [:div.ui__modal-panel
   ...
   [:div {:style {:margin "12px" :max-width "500px"}}
    [:p.text-sm
     ...
     [:a.text-sm
      {:target "_blank" :href "https://discuss.ideamesh.khulnasoft.com/t/whats-your-preferred-outdent-behavior-the-direct-one-or-the-logical-one/978"}
      (t :settings-page/preferred-outdenting-tip-more)]]
    [:img {:src    "https://discuss.ideamesh.khulnasoft.com/uploads/default/original/1X/e8ea82f63a5e01f6d21b5da827927f538f3277b9.gif"
           :width  500
           :height 500}]]])
...
(defn accent-color-row [_in-modal?]
  (let [color-accent (state/sub :ui/radix-color)
        pick-theme [:div.cp__accent-colors-list-wrap
                    ...
                    (for [color (concat [:none :ideamesh] colors/color-list)
                      ...
                      [:div.flex.items-center {:style {:height 28}}
                       (ui/tippy
                         {:html (case color
                                  ...
                                  :ideamesh "Ideamesh classical color"
    ...
    [:div.flex.items-center.gap-2
     ...
     (when (not= (boolean value) on?)
       (ui/button (t :plugin/restart)
                  :on-click #(js/ideamesh.api.relaunch)
                  :small? true :intent "ideamesh"))]))
      ...
      (cond
        ...
        [:div.grid.grid-cols-3.gap-8.pt-2
         ...
         [:div.col-span-2.flex.flex-wrap.gap-4
          [:div.w-full.text-white "With a Ideamesh account, you can access cloud-based services like Ideamesh Sync and alpha/beta features."]
         ...
         [:div.col-span-3.flex.flex-col.gap-4 {:class "bg-black/20 p-4 rounded-lg"}
          [:div.flex.w-full.items-center
           [:div {:class "w-1/2 text-lg"}
            ...
            [:strong {:class "text-white/80"} "Ideamesh Sync"]]
          ...
          [:div.flex.w-full.gap-4
           [:div {:class "w-1/2 bg-black/50 rounded-lg p-4 pt-10 relative flex flex-col gap-4"}
            ...
            [:ul.text-xs.list-none.m-0.flex.flex-col.gap-0.5
             ...
             [:li "No asset syncing"]
             [:li "Access to core Ideamesh features"]]]
           [:div {:class "w-1/2 bg-black/50 rounded-lg p-4 pt-10 relative flex flex-col gap-4"}
            ...
            [:ul.text-xs.list-none.m-0.flex.flex-col.gap-0.5
             ...
             [:li "Upcoming cloud-based features, including Ideamesh Publish"]]]]]])]]))
       ...
       [:<>
        ...
        [:div.flex.flex-col.gap-4
         ...
         [:div.text-sm
          ...
          [:a.mx-1 {:href "https://blog.ideamesh.khulnasoft.com/how-to-setup-and-use-ideamesh-sync/"
                    :target "_blank"}
