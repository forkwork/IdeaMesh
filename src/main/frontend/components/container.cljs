(ns frontend.components.container
  (:require [cljs-drag-n-drop.core :as dnd]
            ...
            [frontend.ui :as ui]
            [ideamesh.shui.ui :as shui]
            [ideamesh.shui.toaster.core :as shui-toaster]
            [ideamesh.shui.dialog.core :as shui-dialog]
...
(def help-menu-items
  [{:title "Handbook" :icon "book-2" :on-click #(handbooks/toggle-handbooks)}
   ...
   {:title "Documentation" :icon "help" :href "https://docs.ideamesh.khulnasoft.com/"}
   :hr
   {:title "Report bug" :icon "bug" :on-click #(rfe/push-state :bug-report)}
   {:title "Request feature" :icon "git-pull-request" :href "https://discuss.ideamesh.khulnasoft.com/c/feedback/feature-requests/"}
   {:title "Submit feedback" :icon "messages" :href "https://discuss.ideamesh.khulnasoft.com/c/feedback/13"}
   :hr
   {:title "Ask the community" :icon "brand-discord" :href "https://discord.com/invite/KpN4eHY"}
   {:title "Support forum" :icon "message" :href "https://discuss.ideamesh.khulnasoft.com/"}
   :hr
   {:title "Release notes" :icon "asterisk" :href "https://docs.ideamesh.khulnasoft.com/#/page/changelog"}])
...
(rum/defc help-menu-popup
  ...
  [:div.cp__sidebar-help-menu-popup
   ...
   [:div.ft.pl-11.pb-3
    [:span.opacity.text-xs.opacity-30 "Ideamesh " version]]])
