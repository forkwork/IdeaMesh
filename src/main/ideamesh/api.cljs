(ns ^:no-doc ideamesh.api
  (:require [cljs-bean.core :as bean]
            [cljs.reader]
            [ideamesh.sdk.core]
            [ideamesh.sdk.git]
            [ideamesh.sdk.utils :as sdk-utils]
            [ideamesh.sdk.ui :as sdk-ui]
            [ideamesh.sdk.assets :as sdk-assets]
            ...
            [ideamesh.api.block :as api-block]))
...
(def ^:export invoke_external_command
  (fn [type & args]
    (when-let [id (and (string/starts-with? type "ideamesh.")
                       (-> (string/replace type #"^ideamesh." "")
