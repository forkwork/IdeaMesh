## Hi, welcome to Ideamesh!
- Ideamesh is a _privacy-first_, [open-source](https://github.com/khulnasoft/ideamesh) platform for _knowledge_ management and collaboration.
- This is a 3 minute tutorial on how to use Ideamesh. Let's get started!
...
- 4. Do you support tasks like todo/doing/done and priorities?
    ...
    - LATER [#A] Check out this awesome video by [:a {:href "https://twitter.com/shuomi3" :target "_blank"} "@shuomi3"] on how to use Ideamesh to take notes and organize your life!
...
- You can also download our desktop app at https://github.com/khulnasoft/ideamesh/releases
