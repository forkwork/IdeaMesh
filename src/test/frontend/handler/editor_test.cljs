...
(deftest extract-nearest-link-from-text-test
  ...
  (testing "Url links"
    (is (= "https://github.com/khulnasoft/ideamesh"
           (editor/extract-nearest-link-from-text
            "https://github.com/khulnasoft/ideamesh is #awesome :)" 0 editor/url-regex))
        "Finds url correctly")

    (is (not= "https://github.com/khulnasoft/ideamesh"
              (editor/extract-nearest-link-from-text
               "https://github.com/khulnasoft/ideamesh is #awesome :)" 0))
        "Doesn't find url if regex not passed")

    (is (= "https://github.com/khulnasoft/ideamesh"
           (editor/extract-nearest-link-from-text
            "[ideamesh](https://github.com/khulnasoft/ideamesh) is #awesome :)" 0 editor/url-regex))
        "Finds url in markdown link correctly"))

  (is (= "https://github.com/khulnasoft/ideamesh"
         (editor/extract-nearest-link-from-text
          "[[https://github.com/khulnasoft/ideamesh][ideamesh]] is #awesome :)" 0 editor/url-regex))
