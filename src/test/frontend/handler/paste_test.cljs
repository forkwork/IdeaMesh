...
(deftest selection-within-link-test
  (are [x y] (= (#'paste-handler/selection-within-link? x) y)
    {:format :markdown
     :value "[ideamesh](https://ideamesh.khulnasoft.com)"
     :selection-start 0
     :selection-end 28
     :selection "[ideamesh](https://ideamesh.khulnasoft.com)"} true
    {:format :markdown
     :value "[ideamesh](https://ideamesh.khulnasoft.com)"
     :selection-start 1
     :selection-end 27
    ...
    {:format :markdown
     ...
     :selection-start 1
     :selection-end 7
     :selection "ideamesh"} true
    {:format :markdown
     :value "[ideamesh](https://ideamesh.khulnasoft.com)"
     :selection-start 9
     :selection-end 27
     :selection "https://ideamesh.khulnasoft.com"} true
    {:format :markdown
     :value "[ideamesh](https://ideamesh.khulnasoft.com) is awesome"
     :selection-start 32
     :selection-end 39
    ...
    {:format :markdown
     ...
     :selection-start 9
     :selection-end 39
     :selection "https://ideamesh.khulnasoft.com) is awesome"} false
    {:format :markdown
     :value "[ideamesh](https://ideamesh.khulnasoft.com) is developed with [Clojure](https://clojure.org)"
     :selection-start 9
     :selection-end 76
     :selection "https://ideamesh.khulnasoft.com) is developed with [Clojure](https://clojure.org"} false))
...
(deftest-async editor-on-paste-with-text-over-link
  (testing "Paste text over a selected formatted link"
    (let [actual-text (atom nil)
          clipboard "ideamesh"
          selected-text "https://ideamesh.khulnasoft.com"
          block-content (str selected-text " is awesome")
          expected-paste "[ideamesh](https://ideamesh.khulnasoft.com) is awesome"]
      (test-helper/with-reset
        reset
        [;; paste-copied-blocks-or-text mocks below
         util/stop (constantly nil)
