...
(deftest test-replace-page-ref!
  (are [x y] (= (let [[content old-name new-name] x]
    ...
    ["bla [[ideamesh/foo]] bla" "ideamesh/foo" "ideamesh/bar"] "bla [[ideamesh/bar]] bla"

    ["bla [[file:./foo.org][foo]] bla" "foo" "bar"]
    "bla [[file:./bar.org][bar]] bla"
    
    ["bla [[file:./ideamesh.foo.org][ideamesh/foo]] bla" "ideamesh/foo" "ideamesh/bar"]
    "bla [[file:./ideamesh.bar.org][ideamesh/bar]] bla"

    ["bla [[file:../pages/ideamesh.foo.org][ideamesh/foo]] bla" "ideamesh/foo" "ideamesh/bar"]
    "bla [[file:../pages/ideamesh.bar.org][ideamesh/bar]] bla"

    ["bla [[file:./pages/ideamesh.foo.org][ideamesh/foo]] bla" "ideamesh/foo" "ideamesh/bar"]
    "bla [[file:./pages/ideamesh.bar.org][ideamesh/bar]] bla"

    ["bla [[file:./pages/ideamesh.foo.org][ideamesh/foo]] bla [[ideamesh/foo]]" "ideamesh/foo" "ideamesh/bar"]
    "bla [[file:./pages/ideamesh.bar.org][ideamesh/bar]] bla [[ideamesh/bar]]"

    ["bla [[file:./pages/ideamesh.foo.org][don't change this label]] bla [[ideamesh/foo]]" "ideamesh/foo" "ideamesh/bar"]
    "bla [[file:./pages/ideamesh.bar.org][don't change this label]] bla [[ideamesh/bar]]"))
...
(deftest test-replace-tag-ref!
  (are [x y] (= (let [[content old-name new-name] x]
    ...
    ["#ideamesh/foo #ideamesh/foobar bar#ideamesh/foo #ideamesh/foo" "ideamesh/foo" "ideamesh/bar"]
    "#ideamesh/bar #ideamesh/foobar bar#ideamesh/foo #ideamesh/bar"
...
(deftest test-replace-old-page!
  (are [x y] (= (let [[content old-name new-name] x]
       ...
       ["#ideamesh/foo bla [[ideamesh/foo]] bla [[file:./pages/ideamesh.foo.org][ideamesh/foo]] bla #ideamesh/foo" "ideamesh/foo" "ideamesh/bar"]
       "#ideamesh/bar bla [[ideamesh/bar]] bla [[file:./pages/ideamesh.bar.org][ideamesh/bar]] bla #ideamesh/bar"))
