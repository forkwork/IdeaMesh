(ns write-rdf
  "This script converts a subset of a Ideamesh graph to an rdf file using
...
(def graph-config
  ...
  {;; Required: Base url for all pages in the graph
   :base-url
   "https://docs.ideamesh.khulnasoft.com/#/page/"
   ...
   :prefixes
   {:d "https://docs.ideamesh.khulnasoft.com/#/page/"
    :s "https://schema.org/"}
