(ns nbb.impl.cljs-time
  "Only some fns are required by ideamesh.graph-parser and are documented.
...
(def core-namespace
  "Only now, days, weeks, months, years, today, minus and plus are used by ideamesh.graph-parser"
