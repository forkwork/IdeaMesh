...
/**
 * In Ideamesh, a graph represents a repository of connected pages and blocks
 */
...
/**
 * Block - Ideamesh's fundamental data structure.
 */
...
export type ExternalCommandType =
  | 'ideamesh.khulnasoft.command/run'
  | 'ideamesh.editor/cycle-todo'
  | 'ideamesh.editor/down'
  | 'ideamesh.editor/up'
  | 'ideamesh.editor/expand-block-children'
  | 'ideamesh.editor/collapse-block-children'
  | 'ideamesh.editor/open-file-in-default-app'
  | 'ideamesh.editor/open-file-in-directory'
  | 'ideamesh.editor/select-all-blocks'
  | 'ideamesh.editor/toggle-open-blocks'
  | 'ideamesh.editor/zoom-in'
  | 'ideamesh.editor/zoom-out'
  | 'ideamesh.editor/indent'
  | 'ideamesh.editor/outdent'
  | 'ideamesh.editor/copy'
  | 'ideamesh.editor/cut'
  | 'ideamesh.go/home'
  | 'ideamesh.go/journals'
  | 'ideamesh.go/keyboard-shortcuts'
  | 'ideamesh.go/next-journal'
  | 'ideamesh.go/prev-journal'
  | 'ideamesh.go/search'
  | 'ideamesh.go/tomorrow'
  | 'ideamesh.go/backward'
  | 'ideamesh.go/forward'
  | 'ideamesh.search/re-index'
  | 'ideamesh.sidebar/clear'
  | 'ideamesh.sidebar/open-today-page'
  | 'ideamesh.ui/goto-plugins'
  | 'ideamesh.ui/select-theme-color'
  | 'ideamesh.ui/toggle-brackets'
  | 'ideamesh.ui/toggle-contents'
  | 'ideamesh.ui/toggle-document-mode'
  | 'ideamesh.ui/toggle-help'
  | 'ideamesh.ui/toggle-left-sidebar'
  | 'ideamesh.ui/toggle-right-sidebar'
  | 'ideamesh.ui/toggle-settings'
  | 'ideamesh.ui/toggle-theme'
  | 'ideamesh.ui/toggle-wide-mode'
...
export interface IAppProxy {
   ...
   * valid state is here
   * https://github.com/khulnasoft/ideamesh/blob/master/src/main/frontend/state.cljs#L27
   *
   * @example
   * ```ts
   * const isDocMode = await ideamesh.App.getStateFromStore('document/mode?')
   * ```
   * @param path
   */
  ...
  /**
   * @deprecated Using `ideamesh.Git.execCommand`
   ...
   *
   * @example https://github.com/khulnasoft/ideamesh-plugin-samples/tree/master/ideamesh-pomodoro-timer
   * @example
   * ```ts
   * // e.g. {{renderer :h1, hello world, green}}
   *
   * ideamesh.App.onMacroRendererSlotted(({ slot, payload: { arguments } }) => {
...
export interface IEditorProxy extends Record<string, any> {
  /**
   * register a custom command which will be added to the Ideamesh slash command list
   ...
   *
   *
   * @example https://github.com/khulnasoft/ideamesh-plugin-samples/tree/master/ideamesh-slash-commands
   *
   * @example
   * ```ts
   * ideamesh.Editor.registerSlashCommand("Say Hi", () => {
   *   console.log('Hi!')
   * })
   * ```
   *
   * @example
   * ```ts
   * ideamesh.Editor.registerSlashCommand("💥 Big Bang", [
   ...
   * @example
   * ```ts
   * const blocks = await ideamesh.Editor.getCurrentPageBlocksTree()
   * initMindMap(blocks)
   * ```
   */
  ...
  /**
   * @example https://github.com/khulnasoft/ideamesh-plugin-samples/tree/master/ideamesh-reddit-hot-news
   *
   * @param srcBlock
   * @param content
   * @param opts
   ...
   *
   * ```ts
   *  ideamesh.Editor.setBlockCollapsed('uuid', true)
   *  ideamesh.Editor.setBlockCollapsed('uuid', 'toggle')
   * ```
   * @param uuid
   * @param opts
   */
  ...
  /**
   * @example https://github.com/khulnasoft/ideamesh-plugin-samples/tree/master/ideamesh-a-translator
   */
...
export interface IDBProxy {
  /**
   * Run a DSL query
   * @link https://docs.ideamesh.khulnasoft.com/#/page/queries
   * @param dsl
   */
...
export interface IAssetsProxy {
  ...
  /**
   * @example https://github.com/khulnasoft/ideamesh/pull/6488
   * @added 0.0.10
   */
  ...
  /**
   * try to open asset type file in Ideamesh app
   * @added 0.0.16
   * @param path
   */
...
export interface ILSPluginUser extends EventEmitter<LSPluginUserEvents> {
  ...
  /**
   * The main Ideamesh app is ready to run the plugin
   *
  ...
  /**
   * @param callback - a function to run when the main Ideamesh app is ready
   */
  ...
  /**
   * Set the theme for the main Ideamesh app
   */
  provideTheme(theme: Theme): this

  /**
   * Inject custom css for the main Ideamesh app
   *
   * @example https://github.com/khulnasoft/ideamesh-plugin-samples/tree/master/ideamesh-awesome-fonts
   * @example
   * ```ts
   *   ideamesh.provideStyle(`
