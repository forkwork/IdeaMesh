...
pub extern "system" fn JNI_OnLoad(vm: JavaVM, _reserved: *mut ()) -> jint {
    ...
    let inst = {
        env.call_static_method(
            "com/ideamesh/app/filesync/FileSyncPlugin",
            "getInstance",
            "()Lcom/ideamesh/app/filesync/FileSyncPlugin;",
            &[],
        )
        .unwrap()
        .l()
...
#[no_mangle]
pub extern "system" fn Java_com_ideamesh_sync_RSFileSync_getLastError(
    env: JNIEnv,
    _class: JClass,
) -> jstring {
    unsafe {
...
#[no_mangle]
pub extern "system" fn Java_com_ideamesh_sync_RSFileSync_cancelAllRequests(
    _env: JNIEnv,
    _class: JClass,
) -> jlong {
...
#[no_mangle]
pub extern "system" fn Java_com_ideamesh_sync_RSFileSync_keygen(
    env: JNIEnv,
    _class: JClass,
) -> jobjectArray {
    let array = env
...
#[no_mangle]
pub extern "system" fn Java_com_ideamesh_sync_RSFileSync_setEnvironment(
    env: JNIEnv,
    _class: JClass,
    graph_uuid: JString,
    variant: JString,
...
#[no_mangle]
pub extern "system" fn Java_com_ideamesh_sync_RSFileSync_encryptFilenames(
    env: JNIEnv,
    _class: JClass,
    graph_uuid: JString,
...
/// Return null when error
#[no_mangle]
pub extern "system" fn Java_com_ideamesh_sync_RSFileSync_decryptFilenames(
    env: JNIEnv,
    _class: JClass,
    graph_uuid: JString,
...
#[no_mangle]
pub extern "system" fn Java_com_ideamesh_sync_RSFileSync_getLocalFilesMeta(
    env: JNIEnv,
    _class: JClass,
    graph_uuid: JString,
    base_path: JString,
    ...
    fn inner(
        ...
        let array =
            env.new_object_array(nfiles as i32, "com/ideamesh/sync/FileMeta", JObject::null())?;
...
#[no_mangle]
pub extern "system" fn Java_com_ideamesh_sync_RSFileSync_getLocalAllFilesMeta(
    env: JNIEnv,
    _class: JClass,
    graph_uuid: JString,
    base_path: JString,
...
#[no_mangle]
pub extern "system" fn Java_com_ideamesh_sync_RSFileSync_renameLocalFile(
    env: JNIEnv,
    _class: JClass,
    _graph_uuid: JString,
    base_path: JString,
...
#[no_mangle]
pub extern "system" fn Java_com_ideamesh_sync_RSFileSync_deleteLocalFiles(
    env: JNIEnv,
    _class: JClass,
    _graph_uuid: JString,
    base_path: JString,
...
// returns String[]
#[no_mangle]
pub extern "system" fn Java_com_ideamesh_sync_RSFileSync_fetchRemoteFiles(
    env: JNIEnv,
    _class: JClass,
    graph_uuid: JString,
    base_path: JString,
...
#[no_mangle]
pub extern "system" fn Java_com_ideamesh_sync_RSFileSync_updateLocalFiles(
    env: JNIEnv,
    _class: JClass,
    graph_uuid: JString,
    base_path: JString,
...
#[no_mangle]
pub extern "system" fn Java_com_ideamesh_sync_RSFileSync_updateLocalVersionFiles(
    env: JNIEnv,
    _class: JClass,
    graph_uuid: JString,
    base_path: JString,
...
#[no_mangle]
pub extern "system" fn Java_com_ideamesh_sync_RSFileSync_deleteRemoteFiles(
    env: JNIEnv,
    _class: JClass,
    graph_uuid: JString,
    base_path: JString,
...
#[no_mangle]
pub extern "system" fn Java_com_ideamesh_sync_RSFileSync_updateRemoteFiles(
    env: JNIEnv,
    _class: JClass,
    graph_uuid: JString,
    base_path: JString,
...
#[no_mangle]
pub extern "system" fn Java_com_ideamesh_sync_RSFileSync_ageEncryptWithPassphrase(
    env: JNIEnv,
    _class: JClass,
    passphrase: JString,
    buf: jbyteArray,
...
#[no_mangle]
pub extern "system" fn Java_com_ideamesh_sync_RSFileSync_ageDecryptWithPassphrase(
    env: JNIEnv,
    _class: JClass,
    passphrase: JString,
    buf: jbyteArray,
...
fn to_java_file_meta<'a>(env: JNIEnv<'a>, metadata: &FileMeta) -> Result<JObject<'a>> {
    // construct com.ideamesh.sync.FileMeta
    let class = env.find_class("com/ideamesh/sync/FileMeta").unwrap();
