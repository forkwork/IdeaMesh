...
// API URL base
static mut URL_BASE: &str = "https://api-dev.ideamesh.khulnasoft.com/file-sync/";
static mut BUCKET: &str = "ideamesh-file-sync-bucket";
static mut REGION: &str = "us-east-2";

const URL_BASE_DEV: &str = "https://api-dev.ideamesh.khulnasoft.com/file-sync/";
const BUCKET_DEV: &str = "ideamesh-file-sync-bucket";
const REGION_DEV: &str = "us-east-2";

const URL_BASE_PROD: &str = "https://api.ideamesh.khulnasoft.com/file-sync/";
const BUCKET_PROD: &str = "ideamesh-file-sync-bucket-prod";
