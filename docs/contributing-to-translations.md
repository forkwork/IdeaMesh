...
commandline tools, know how to switch languages within Ideamesh and basic
...
[src/resources/dicts/](https://github.com/khulnasoft/ideamesh/blob/master/src/resources/dicts/) with each language having its own file. For example, the es locale is in `es.edn`.

## Language Overview

First, let's get an overview of Ideamesh's languages and how many translations your
...
Almost all translations are small. The only exceptions to this are the keys `:tutorial/text` and `:tutorial/dummy-notes`. These translations are files that are part of the onboarding tutorial and can be found under [src/resources/tutorials/](https://github.com/khulnasoft/ideamesh/blob/master/src/resources/tutorials/).
...
[lang.clj](https://github.com/khulnasoft/ideamesh/blob/master/scripts/src/ideamesh/tasks/lang.clj) for your language
